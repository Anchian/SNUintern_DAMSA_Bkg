...
void rootmacro() {
    ...
    int nEntries_pair_distance_distribution = tree6->GetEntries("distance_distribution!=0");
    int nEntries_pair_transverse_distance_distribution = tree6->GetEntries("transverse_distance_distribution_cut!=0");
    int nEntries_pair_z_distance_distribution = tree6->GetEntries("z_distance_distribution!=0");
    int nEntries_pair_distance_distribution_cut = tree6->GetEntries("cut_distance_distribution!=0");
    int nEntries_pair_transverse_distance_distribution_cut = tree6->GetEntries("cut_transverse_distance_distribution!=0");
    int nEntries_pair_z_distance_distribution_cut = tree6->GetEntries("cut_z_distance_distribution!=0");
    ...
    TH1F *hist2_pair_distance_distribution_cut = new TH1F("hist2_pair_distance_distribution_cut", "Pair Distance Distribution (Cut);Distance (mm);Number of Particles", bins_pair_distance_distribution_cut, 0, 2);
    TH1F *hist2_pair_transverse_distance_distribution_cut = new TH1F("hist2_pair_transverse_distance_distribution_cut", "Pair Transverse Distance Distribution (Cut);Transverse Distance (mm);Number of Particles", bins_pair_transverse_distance_distribution_cut, 0, 2);
    TH1F *hist2_pair_z_distance_distribution_cut = new TH1F("hist2_pair_z_distance_distribution_cut", "Pair Z Distance Distribution (Cut);Z Distance (mm);Number of Particles", bins_pair_z_distance_distribution_cut, 0, 0.1);
    // 데이터 필터링 및 히스토그램 채우기
